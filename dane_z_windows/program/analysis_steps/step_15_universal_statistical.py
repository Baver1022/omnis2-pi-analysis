...
class Step15UniversalStatistical(AnalysisStep):
    ...
    def execute(self, digits: np.ndarray, checkpoint_data: Optional[Dict] = None) -> Dict:
        ...
        print(f"   [OK] Utworzono {len(blocks)} bloków")
        
        # Faza inicjalizacji: Q pierwszych bloków
        print("   [PROC] Faza inicjalizacji (Q bloków)...")
        ...
        print("   [PROC] Faza testowa (obliczanie odległości)...")
        ...
        print(f"   [OK] Obliczono {len(distances)} odległości")
